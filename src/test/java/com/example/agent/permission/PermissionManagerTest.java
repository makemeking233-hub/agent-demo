...
import com.example.agent.tools.LsTool;
...
class PermissionManagerTest {
    ...
    void shellAsks() {
        var mgr = new PermissionManager(PermissionPolicy.defaults());
        var d = mgr.decide("Shell", new Tool() {
            ...
            @Override public reactor.core.publisher.Mono<com.example.agent.tools.ToolResult<Object>> execute(Object input, ToolContext ctx) {
