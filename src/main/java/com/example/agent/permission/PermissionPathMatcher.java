 ...
 * <p>Rules:
 * <ul>
 *   <li>double-star matches any chars across segments (including /)</li>
 *   <li>single-star matches any chars within one segment (excluding /)</li>
 *   <li>double-star-slash can match empty path so .env matches the env pattern</li>
 *   <li>Case-sensitive (POSIX path semantics)</li>
 * </ul>
 */
public class PermissionPathMatcher {
     ...
     * <p>Order: backslash escape, dot escape, double-star-slash placeholder,
     * double-star to any, single-star to non-slash, then placeholder to optional-path-prefix.
     */
