...
public class PermissionManager {
  ...
  private PermissionDecision decideByCategory(ToolCategory category) {
    return switch (category) {
      case READ -> policy.defaultRead() ? PermissionDecision.allow() : PermissionDecision.ask();
      case WRITE -> policy.defaultWrite() ? PermissionDecision.allow() : PermissionDecision.ask();
