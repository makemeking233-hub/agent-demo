 ...
 *
 * <p>v0.2 拆分为两个独立类后保留此门面以兼容既有调用（{@code DeepSeekProvider} 仍引用它）。 新代码请直接引用 RequestMapper /
 * ResponseParser。
 */
public class DeepSeekMapper {
   ...
   */
  public Optional<com.example.agent.llm.StreamChunk> parseSseLine(String line) {
