...
function TooltipContent({
  ...
  return /* @__PURE__ */ React.createElement(TooltipPrimitive.Portal, null, " ", /* @__PURE__ */ React.createElement(
    ...
    children,
    " ",
    /* @__PURE__ */ React.createElement(TooltipPrimitive.Arrow, { className: "z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] bg-foreground fill-foreground" }),
    " "
  ), " ");
}
export {
