...
import com.example.agent.core.exception.CompactCircuitBrokenException;
...
public class ContextCompressor {
    ...
    private String loadPrompt() {
        ...
        String loaded =
                com.example.agent.util.PromptLoader.loadOrFallback(
                        "/prompts/summarize.txt", fallback);
    ...
    private MessageHistory collapseMessages(MessageHistory hist, String summary) {
        ...
        MessageHistory newHist = new MessageHistory(new com.example.agent.llm.TokenEstimator());
